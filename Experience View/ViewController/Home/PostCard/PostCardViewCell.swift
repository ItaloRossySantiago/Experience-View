...
class PostCollectionViewCellScreen: UIView {
    ...
    lazy var descriptionLabel: UILabel =  {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "description of a post"
        label.font = UIFont.systemFont(ofSize: 14, weight: .semibold)
        return label
    }()
    ...
    private func configConstraints() {
        NSLayoutConstraint.activate([
            ...
            postImageView.bottomAnchor.constraint(equalTo: cardView.bottomAnchor, constant: -50),
            ...
            descriptionLabel.topAnchor.constraint(equalTo: postImageView.bottomAnchor, constant: 7),
